...
- Fourteen distinct wedding proposal designs, with template-specific section headings and layouts.
...
Projects are stored in the browser used to edit them. Clearing that browser's site data removes its saved project. Uploaded photos are resized before storage. Demo galleries use curated Unsplash URLs and require an internet connection.
